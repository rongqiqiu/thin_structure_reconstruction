...
const Eigen::Vector3d feature_point(-2704637.217010, -4261735.578278, 3886083.003075);
...
int main() {
	...
	data_parser.SetExportRawPoints(true);
	...
	ThinStructureReconstructor reconstructor(dataset);
	reconstructor.ParseDataset();
	reconstructor.ExportRawPoints(export_directory + "raw_points.xyz");
