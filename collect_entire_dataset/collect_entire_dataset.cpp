...
int main(int argc, char** argv) {
	...
	ofstream out_stream(output_directory + "truncated_cone_hypotheses_with_radii_offsets_extents.dat");
	...
	for (int region_index_x = 0; region_index_x < 5; ++ region_index_x) {
		for (int region_index_y = 0; region_index_y < 5; ++ region_index_y) {
			...
			cout << sub_directory + "truncated_cone_hypotheses_with_radii_offsets_extents.dat" << endl;

			double p1x, p1y, p1z, p2x, p2y, p2z, r1, r2;
			ifstream in_stream(sub_directory + "truncated_cone_hypotheses_with_radii_offsets_extents.dat");
