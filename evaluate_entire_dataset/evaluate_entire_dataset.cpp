...
void AnalyzeDetections(const vector<TruncatedConePrimitive>& outputs, const vector<TruncatedConePrimitive>& ground_truths, const string& file_name) {
...
int main(int argc, char** argv) {
	...
	AnalyzeDetections(outputs, ground_truths, run_directory + "qauntitative_results.txt");
